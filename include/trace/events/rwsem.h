...
TRACE_EVENT(rw_sem_debug,
	...
	TP_PROTO(pid_t owner_pid, char *func,
	...
	TP_ARGS(owner_pid, func, caller_addr0, caller_addr1, caller_addr2, caller_addr3, caller_addr4, caller_addr5),
	...
	TP_printk("func=%s, owner_pid=%d, caller=(%pS<-%pS<-%pS<-%pS<-%pS<-%pS)",
			__get_str(function), __entry->owner_pid,
			(void *)__entry->addr0, (void *)__entry->addr1,
			(void *)__entry->addr2, (void *)__entry->addr3,
			(void *)__entry->addr4, (void *)__entry->addr5)
);
#endif
