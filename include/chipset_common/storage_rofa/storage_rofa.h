...
void storage_rofi_inject_fault_check_condition_sense(
	int *result, int *sense_valid, int *sense_deferred,
	unsigned int *good_bytes, struct request *req, struct scsi_device *sdp,
...
int storage_rochk_ioctl_check_bootdisk_wp(struct bootdisk_wp_status_iocb *arg);
int storage_rochk_ioctl_enable_monitor(struct storage_rochk_iocb *arg);
int storage_rochk_ioctl_run_storage_wrtry_sync(struct storage_rochk_iocb *arg);
int storage_rofa_ioctl_get_rofa_info(struct storage_rofa_info_iocb *arg);
