...
void set_buddy_track(struct page *page, unsigned int order,
		     unsigned long caller);
void set_lslub_track(struct page *page, unsigned int order,
		     unsigned long caller);
...
static inline size_t mm_page_trace_read(int type, struct mm_stack_info *info,
					size_t len, int subtype)
{
	return 0;
}
static inline void set_buddy_track(struct page *page, unsigned int order,
				   unsigned long caller)
{
}
static inline void set_lslub_track(struct page *page, unsigned int order,
				   unsigned long caller)
{
}
