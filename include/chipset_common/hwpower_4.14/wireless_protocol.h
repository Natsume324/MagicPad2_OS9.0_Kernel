...
int wireless_get_tx_fop_range(int prot,
			      struct wireless_protocol_tx_fop_range *fop);
int wireless_auth_encrypt_start(int prot, int key, u8 *random, int r_size,
				u8 *hash, int h_size);
...
static inline int
wireless_protocol_ops_register(struct wireless_protocol_ops *ops)
{
	return -1;
}
...
static inline int
wireless_get_tx_capability(int prot, struct wireless_protocol_tx_cap *cap)
{
	return -1;
}

static inline int
wireless_get_tx_fop_range(int prot, struct wireless_protocol_tx_fop_range *fop)
{
	return -1;
}

static inline int wireless_auth_encrypt_start(int prot, int key, u8 *random,
