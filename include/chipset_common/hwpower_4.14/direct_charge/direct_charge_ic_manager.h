...
int dc_get_bat_btb_voltage_with_comp(int mode, unsigned int type,
				     const int *vbat_comp);
...
static inline int dc_set_vusb_uv_det(int mode, unsigned int type, u8 val)
{
	return -1;
}
...
static inline int dc_get_bat_btb_voltage_with_comp(int mode, unsigned int type,
						   const int *vbat_comp)
{
	return -1;
}

static inline int dc_get_bat_max_btb_voltage_with_comp(int mode,
						       const int *vbat_comp)
{
	return -1;
}
...
static inline int dc_get_bat_current_with_calibration(int mode,
						      unsigned int type,
						      int *ibat, int comb)
{
	return -1;
