...
int power_compensation_get_ntc_temp(int ntc_compensation_is,
				    struct compensation_para *para,
				    int temp_val, int cur_temp);
#else
static inline void
power_compensation_parse_ntc_para(const struct device_node *np,
				  int *ntc_compensation_is,
				  struct compensation_para *para)
{
}
...
static inline int
power_compensation_get_ntc_temp(int ntc_compensation_is,
				struct compensation_para *para, int temp_val,
				int cur_temp)
{
	return -1;
}
