...
struct power_platform_sc_get_fault_notifier_ops {
	void (*hihonor_sc_get_fault_notifier)(
		struct atomic_notifier_head **notifier_list);
};

struct power_platform_lvc_get_fault_notifier_ops {
	void (*hihonor_lvc_get_fault_notifier)(
		struct atomic_notifier_head **notifier_list);
};
...
struct power_platform_if_info {
	...
	struct power_platform_sc_get_fault_notifier_ops
		*sc_get_fault_notifier_ops;
	struct power_platform_lvc_get_fault_notifier_ops
		*lvc_get_fault_notifier_ops;
	struct power_platform_wlc_ilimit_notifier_ops
		*wlc_set_input_limit_notifier_ops;
};

int power_platform_if_chipset_ops_register(
	struct power_platform_if_chipset_ops *ops);
int power_platform_if_chipset_mmi_ops_register(
	struct power_platform_if_chipset_mmi_ops *ops);
int power_platform_if_qcom_ops_register(struct power_platform_if_qcom_ops *ops);
int power_platform_if_dc_cable_ops_register(
	struct power_platform_if_dc_cable_ops *ops);
int power_platform_if_dc_adapter_ops_register(
	struct power_platform_if_dc_adapter_ops *ops);
int power_platform_if_path_switch_ops_register(
	struct power_platform_if_path_switch_ops *ops);
int power_platform_if_dc_uevent_ops_register(
	struct power_platform_if_dc_uevent_ops *ops);
int power_platform_if_usb_glink_ops_register(
	struct power_platform_if_usb_glink_ops *ops);
int power_platform_if_wireless_charge_ops_register(
	struct power_platform_if_wireless_charge_ops *ops);
int power_platform_if_uscp_ops_register(struct power_platform_if_uscp_ops *ops);
int power_platform_if_honor_battery_ops_register(
	struct power_platform_if_honor_battery_ops *ops);
int power_platform_dc_charger_ops_register(
	struct power_platform_dc_charger_ops *ops);
int power_platform_sc_get_fault_notifier_ops_register(
	struct power_platform_sc_get_fault_notifier_ops *ops);
int power_platform_lvc_get_fault_notifier_ops_register(
	struct power_platform_lvc_get_fault_notifier_ops *ops);
int power_platform_wlc_ilimit_notifier_ops_register(
	struct power_platform_wlc_ilimit_notifier_ops *ops);
...
static inline void
power_atomic_notifier_call_chain(struct atomic_notifier_head *nh,
