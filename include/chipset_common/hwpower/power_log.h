...
void power_log_construct_head(struct power_log_format *format_tbl, int tbl_num,
			      char *head);
void power_log_construct_content(struct power_log_format *format_tbl,
				 int tbl_num, void *data[], int data_num,
				 char *content);
