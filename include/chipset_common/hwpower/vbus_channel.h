...
static inline int vbus_ch_close(unsigned int user, unsigned int type, int flag,
				int force)
{
	return -1;
}

static inline int vbus_ch_get_state(unsigned int user, unsigned int type,
				    int *state)
{
	return -1;
}

static inline int vbus_ch_get_mode(unsigned int user, unsigned int type,
				   int *mode)
{
	return -1;
}

static inline int vbus_ch_set_switch_mode(unsigned int user, unsigned int type,
					  int mode)
{
	return -1;
}

static inline int vbus_ch_set_voltage(unsigned int user, unsigned int type,
				      int volt)
{
	return -1;
}

static inline int vbus_ch_get_voltage(unsigned int user, unsigned int type,
				      int *volt)
{
	return -1;
}
