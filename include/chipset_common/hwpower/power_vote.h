...
typedef int (*power_vote_cb)(struct power_vote_object *, void *, int,
			     const char *);

int power_vote_create_object(const char *name, int vote_type, power_vote_cb cb,
			     void *data);
void power_vote_destroy_object(const char *name);
int power_vote_set(const char *name, const char *client_name, bool enabled,
		   int value);
int power_vote_set_always(const char *name, const char *client_name,
			  bool enabled, int value);
int power_vote_set_override(const char *name, const char *client_name,
			    bool enabled, int value);
