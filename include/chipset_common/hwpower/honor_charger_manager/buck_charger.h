...
struct buck_charger_check_dmd {
	void (*check_dmd_info)(int val);
};
...
struct buck_charge_device_info {
	...
	struct buck_charger_check_dmd *check_dmd_ops;
...
int buck_charger_check_dmd_register(struct buck_charger_check_dmd *ops);
