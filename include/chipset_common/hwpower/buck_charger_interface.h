...
int buck_charger_interface_adapter_register(
	struct buck_charger_interface_adapter_ops *ops);
int buck_charger_interface_adapter_unregister(
	struct buck_charger_interface_adapter_ops *ops);

int buck_charger_interface_get_info(enum buck_charger_if_info_type type,
				    int *val);
int buck_charger_interface_set_info(enum buck_charger_if_info_type type,
				    int val);
int buck_charger_interface_set_vote_val(
	enum buck_charger_vote_name name, enum charger_voter chg_voter,
	enum buck_charger_set_vote_type set_type, int val);
int buck_charger_interface_get_vote_val(
	enum buck_charger_vote_name name, enum charger_voter chg_voter,
	enum buck_charger_get_vote_type get_type, int *val);
