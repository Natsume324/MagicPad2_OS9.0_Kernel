...
extern int wired_chsw_set_wired_channel(int channel_type,
					const char *client_name, int state);
...
extern int wired_chsw_set_aux_wired_channel_wireless(int channel_type,
						     int state);
#else
...
static inline int wired_chsw_set_wired_channel(int channel_type,
...
static inline int wired_chsw_set_wired_channel_wireless(int channel_type,
							int state)
{
	return 0;
}

static inline int wired_chsw_set_aux_wired_channel_wireless(int channel_type,
							    int state)
{
	return 0;
}
