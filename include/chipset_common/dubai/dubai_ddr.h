...
typedef int32_t (*dubai_ddr_get_time_in_state_fn_t)(
	struct dubai_ddr_time_in_state *time_in_state);
typedef int32_t (*dubai_ddr_get_ip_stats_fn_t)(
	int32_t ip_cnt, struct dubai_ddr_ip_stats *ip_stats);
typedef int32_t (*dubai_ddr_get_vote_info_fn_t)(
	struct dubai_ddr_ss_vote_info *ss_vote_info);
typedef int32_t (*dubai_cx_get_vote_info_fn_t)(
	struct dubai_cx_ss_vote_info *cx_vote_info);
typedef int32_t (*dubai_cx_get_level_fn_t)(void);
...
struct dubai_ddr_stats_ops {
	...
	dubai_cx_get_vote_info_fn_t get_cx_vote_info;
	dubai_cx_get_level_fn_t get_cx_level;
};
