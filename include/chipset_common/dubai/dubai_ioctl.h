...
#define DUBAI_DIR_IOC(dir, type, nr, param) \
	_IO##dir(DUBAI_IOC_##type, nr, param)
#define DUBAI_IOC(type, nr) _IO(DUBAI_IOC_##type, nr)
#define DUBAI_DISPLAY_DIR_IOC(dir, nr, param) \
	DUBAI_DIR_IOC(dir, DISPLAY, nr, param)
...
#define DUBAI_SENSORHUB_DIR_IOC(dir, nr, param) \
	DUBAI_DIR_IOC(dir, SENSORHUB, nr, param)
#define DUBAI_BATTERY_DIR_IOC(dir, nr, param) \
	DUBAI_DIR_IOC(dir, BATTERY, nr, param)
...
#define DUBAI_UFS_DIR_IOC(dir, nr, param) DUBAI_DIR_IOC(dir, UFS, nr, param)
