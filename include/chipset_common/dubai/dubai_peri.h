...
typedef int32_t (*dubai_peri_get_volt_time_fn_t)(
	int32_t volt_cnt, struct dubai_peri_volt_time *volt_time);
typedef int32_t (*dubai_peri_get_ip_stats_fn_t)(
	int32_t ip_cnt, struct dubai_peri_ip_stats *ip_stats);
