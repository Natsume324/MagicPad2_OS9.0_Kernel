...
#define HWDUBAI_pr(tag, fmt, ...)                                      \
	hievent_to_write(HW_LOG_PRIO_DEBUG, HW_LOG_ID_DUBAI, tag, fmt, \
			 ##__VA_ARGS__)
#endif

#ifndef HWDUBAI_LOGV
#define HWDUBAI_LOGV(tag, fmt, ...)                                      \
	hievent_to_write(HW_LOG_PRIO_VERBOSE, HW_LOG_ID_DUBAI, tag, fmt, \
			 ##__VA_ARGS__)
#endif
...
#define HWDUBAI_LOGI(tag, fmt, ...)                                   \
	hievent_to_write(HW_LOG_PRIO_INFO, HW_LOG_ID_DUBAI, tag, fmt, \
			 ##__VA_ARGS__)
#endif

#ifndef HWDUBAI_LOGW
#define HWDUBAI_LOGW(tag, fmt, ...)                                   \
	hievent_to_write(HW_LOG_PRIO_WARN, HW_LOG_ID_DUBAI, tag, fmt, \
			 ##__VA_ARGS__)
#endif

#ifndef HWDUBAI_LOGE
#define HWDUBAI_LOGE(tag, fmt, ...)                                    \
	hievent_to_write(HW_LOG_PRIO_ERROR, HW_LOG_ID_DUBAI, tag, fmt, \
			 ##__VA_ARGS__)
#endif
