...
static inline int
hitrace_is_flag_enabled(const struct hitrace_id_struct *id_pointer,
...
static inline void hitrace_set_flags(struct hitrace_id_struct *id_pointer,
				     int flags)
{
...
hitrace_get_chain_id(const struct hitrace_id_struct *id_pointer)
{
	if (!hitrace_is_valid(id_pointer))
		return 0;
...
static inline uint64_t
hitrace_get_span_id(const struct hitrace_id_struct *id_pointer)
{
	if (!hitrace_is_valid(id_pointer))
		return 0;
...
static inline void hitrace_set_span_id(struct hitrace_id_struct *id_pointer,
				       uint64_t span_id)
{
	if (hitrace_is_valid(id_pointer))
...
static inline uint64_t
hitrace_get_parent_span_id(const struct hitrace_id_struct *id_pointer)
{
	if (!hitrace_is_valid(id_pointer))
		return 0;
...
static inline void
hitrace_set_parent_span_id(struct hitrace_id_struct *id_pointer,
