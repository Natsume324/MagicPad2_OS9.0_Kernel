...
extern __printf(4, 5) void saudit_log(int idx, int status, unsigned int flags,
				      const char *fmt, ...);
...
static inline int kernel_stp_upload(struct stp_item result,
				    const char *addition_info)
{
	return 0;
}
