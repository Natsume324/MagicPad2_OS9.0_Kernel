...
#define BFMR_ACTION_TIMER_CTL \
	_IOW(BFMR_IOCTL_BASE, 11, struct action_ioctl_data)
#define BFMR_IOC_CREATE_DYNAMIC_RAMDISK \
	_IOWR(BFMR_IOCTL_BASE, 12, struct bfmr_dbrd_ioctl_block)
#define BFMR_IOC_DELETE_DYNAMIC_RAMDISK \
	_IOW(BFMR_IOCTL_BASE, 13, struct bfmr_dbrd_ioctl_block)
#define BFMR_IOC_CHECK_BOOTDISK_WP \
	_IOWR(BFMR_IOCTL_BASE, 14, struct bfmr_bootdisk_wp_status_iocb)
#define BFMR_IOC_ENABLE_MONITOR \
	_IOW(BFMR_IOCTL_BASE, 15, struct bfmr_storage_rochk_iocb)
#define BFMR_IOC_DO_STORAGE_WRTRY \
	_IOWR(BFMR_IOCTL_BASE, 16, struct bfmr_storage_rochk_iocb)
#define BFMR_IOC_GET_STORAGE_ROFA_INFO \
	_IOWR(BFMR_IOCTL_BASE, 17, struct bfmr_storage_rofa_info_iocb)
#define BFMR_IOC_GET_BOOTDEVICE_DISK_COUNT \
	_IOWR(BFMR_IOCTL_BASE, 18, struct bfmr_storage_rochk_iocb)
#define BFMR_IOC_GET_BOOTDEVICE_DISK_INFO \
	_IOWR(BFMR_IOCTL_BASE, 19, struct bfmr_bootdevice_disk_info_iocb)
#define BFMR_IOC_GET_BOOTDEVICE_PROD_INFO \
	_IOWR(BFMR_IOCTL_BASE, 20, struct bfmr_bootdevice_prod_info_iocb)
