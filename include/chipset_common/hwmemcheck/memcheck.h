...
#define LOGGER_MEMCHECK_GET_FD_STAT _IO(__MEMCHECKIO, 11)

#define LOGGER_MEMCHECK_MIN LOGGER_MEMCHECK_GET_MEMSTAT
#define LOGGER_MEMCHECK_MAX LOGGER_MEMCHECK_GET_FD_STAT
...
#define IDX_USER_GPU (IDX_PSS_EXTRA_START + 2)
...
#define MTYPE_USER_GPU (1 << IDX_USER_GPU)
...
#define MTYPE_USER_PSS \
	(MTYPE_USER_PSS_JAVA | MTYPE_USER_PSS_NATIVE | MTYPE_USER_PSS_MMAP)
#define MTYPE_KERNEL                                                 \
	(MTYPE_KERN_ION | MTYPE_KERN_SLUB | MTYPE_KERN_LSLUB |       \
	 MTYPE_KERN_VMALLOC | MTYPE_KERN_CMA | MTYPE_KERN_ZSMALLOC | \
	 MTYPE_KERN_BUDDY | MTYPE_KERN_SKB)
#define MTYPE_USER                                          \
	(MTYPE_USER_PSS | MTYPE_USER_VSS | MTYPE_USER_ION | \
	 MTYPE_USER_PSS_FDTRACK | MTYPE_USER_GPU)
...
#define ADDR_ION_ENABLE (1 << 12)
#define ADDR_ION_DISABLE (1 << 13)
#define ADDR_ION_SAVE (1 << 14)
#define ADDR_ION_CLEAR (1 << 15)
#define ADDR_GPU_ENABLE (1 << 16)
#define ADDR_GPU_DISABLE (1 << 17)
#define ADDR_GPU_SAVE (1 << 18)
#define ADDR_GPU_CLEAR (1 << 19)
#define ADDR_FD_TRACK_ENABLE (1 << 20)
#define ADDR_FD_TRACK_DISABLE (1 << 21)
#define ADDR_FD_TRACK_SAVE (1 << 22)
#define ADDR_FD_TRACK_CLEAR (1 << 23)
...
enum fd_stat_type { FD_NEXT_TO_USE, FD_IN_USE_ALL, FD_IN_USE_PIPE, FD_UNKNOWN };
...
static inline int memcheck_report_lmk_oom(pid_t pid, pid_t tgid,
					  const char *name,
