...
#define EIMA_MAX_MEASURE_OBJ_CNT \
	10 /* Maximum number of targets per policy metric */
...
struct m_entry {
	...
	uint8_t fn[EIMA_NAME_STRING_LEN +
		   1]; /* File name string to store array */
};
...
struct m_list_msg {
	...
	struct m_entry
		m_list[EIMA_MAX_MEASURE_OBJ_CNT]; /* Measure target array */
};
