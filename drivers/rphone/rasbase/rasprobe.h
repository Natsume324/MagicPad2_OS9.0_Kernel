...
#define rasprobe_init(fun)                                                \
	{                                                                 \
		.kp.symbol_name = #fun, .handler = rasprobe_handler(fun), \
...
#define rasprobe_init_entry(fun)                                      \
	{                                                             \
		.kp.symbol_name = #fun, .handler = post_null_handler, \
...
#define rasprobe_entry_exit_define(fun)             \
	static struct rasprobe rasprobe_name(fun) = \
		rasprobe_init_entry_exit(fun)
