...
static int dsm_ufs_show(struct seq_file *s, void *data)
{
	...
	ufs_dsm_report(hba, DSM_UFS_UIC_TRANS_ERR, "UIC No Fatal Error, %s:%d\n",
		__func__, __LINE__);
	...
	ufs_dsm_report(hba, DSM_UFS_UTP_ERR, "UTP Transfer Error, %s:%d\n",
		__func__, __LINE__);
	seq_printf(s, "DSM_UFS_SCSI_CMD_ERR:928008009\n");
	ufs_dsm_report(hba, DSM_UFS_SCSI_CMD_ERR, "UFS SCSI Cmd Error, %s:%d\n",
		__func__, __LINE__);
	seq_printf(s, "DSM_UFS_LINKUP_ERR:928008011\n");
	ufs_dsm_report(hba, DSM_UFS_LINKUP_ERR, "UFS Linkup Error, %s:%d\n",
		__func__, __LINE__);
	seq_printf(s, "DSM_UFS_ENTER_OR_EXIT_H8_ERR:928008012\n");
	ufs_dsm_report(hba, DSM_UFS_ENTER_OR_EXIT_H8_ERR, "UFS Enter/Exit H8 Fail, %s:%d\n",
		__func__, __LINE__);
	...
	ufs_dsm_report(hba, DSM_UFS_DEV_INTERNEL_ERR, "UFS DEV Internel Error:Sense_key = 3, %s:%d\n",
		__func__, __LINE__);
	seq_printf(s, "DSM_UFS_INLINE_CRYPTO_ERR:928008017\n");
	ufs_dsm_report(hba, DSM_UFS_INLINE_CRYPTO_ERR, "UFS Inline Crypto Error, %s:%d\n",
		__func__, __LINE__);
	seq_printf(s, "DSM_UFS_HARDWARE_ERR:928008018\n");
	ufs_dsm_report(hba, DSM_UFS_HARDWARE_ERR, "UFS Hardware Error:Sense_key = 4, %s:%d\n",
		__func__, __LINE__);
	...
	ufs_dsm_report(hba, DSM_UFS_DEVICE_RESET_ERR, "UFS Occur Device Reset and Restore, %s:%d\n",
		__func__, __LINE__);
	seq_printf(s, "DSM_UFS_QCOM_BER_ERR:928008030\n");
	ufs_dsm_report(hba, DSM_UFS_QCOM_BER_ERR, "UFS Qcom Ber Error, %s:%d\n",
		__func__, __LINE__);
