...
#define HP_SPACE_INFO_DEV_INITED 0x02
#define HP_SPACE_INFO_LOOP_DEV_INITED 0x04
/*must align 4*256k*/
#define HP_SPACE_MAX_NR 2
#define HP_SPACE_PARTITION 0
#define HP_SPACE_FIRST_FILE 1
#define BLOCK_SECTOR_SHIFT 3

struct hyperhold_space {
	...
	unsigned long start;
	unsigned long end;
	bool pddr_continuous;
};

enum hyperhold_space_type {
	HP_PARTITION_ARCHIVAL = 0,
	HP_PARTITION_FILE_ARCHIVAL,
};

struct hyperhold_space_dev_info {
	u64 index;
	char file_name[HYPERHOLD_NAME_LEN];
	char bdev_name[HYPERHOLD_NAME_LEN];
	u64 size;
...
struct hyperhold_space_loopdev_info {
	u64 index;
	char file_name[HYPERHOLD_NAME_LEN];
	char bdev_name[HYPERHOLD_NAME_LEN];
	u64 size;
};
extern struct hyperhold_space_dev_info dev_info;
extern struct hyperhold_space_loopdev_info loopdev_info;
#endif
...
#ifdef CONFIG_HYPERHOLD_FILE_ARCHIVAL
	struct hyperhold_space backing_bdev[HP_SPACE_MAX_NR];
	int bdev_count;
	atomic_t space_type;
#endif
};
