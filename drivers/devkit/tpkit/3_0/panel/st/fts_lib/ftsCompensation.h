...
#define RETRY_COMP_DATA_READ \
	2 /* /< max number of attempts to read
				 * initialization data */

/* Bytes dimension of Compensation Data Format */

#define COMP_DATA_HEADER \
	DATA_HEADER /* /< size in bytes of
						 * initialization data header */
#define COMP_DATA_GLOBAL \
	(16 - COMP_DATA_HEADER) /* /< size in bytes
							  * of initialization
							  *data general info */
