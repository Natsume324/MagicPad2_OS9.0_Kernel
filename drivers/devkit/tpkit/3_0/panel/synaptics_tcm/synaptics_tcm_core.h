...
#define SHOW_PROTOTYPE(m_name, a_name)                                     \
	static ssize_t CONCAT(m_name##_sysfs, _##a_name##_show)(           \
		...
		char *buf);                                                \
                                                                           \
	static struct device_attribute dev_attr_##a_name = __ATTR(         \
		a_name, S_IRUGO, CONCAT(m_name##_sysfs, _##a_name##_show), \
...
#define STORE_PROTOTYPE(m_name, a_name)                                      \
	...
	static struct device_attribute dev_attr_##a_name =                   \
		__ATTR(a_name, (S_IWUSR | S_IWGRP), tskit_driver_show_error, \
...
extern int tskit_driver_write_hdl_message(
