 ...
 * By default, this flag is enabled.
 */
#define CONFIG_ENABLE_APK_PRINT_FIRMWARE_SPECIFIC_LOG \
...
#define CHIP_TYPE_MSG21XXA \
	(0x02) // EX. MSG2133A/MSG2138A(Besides, use version to distinguish MSG2133A/MSG2138A, you may refer to _DrvFwCtrlUpdateFirmwareCash())
#define CHIP_TYPE_MSG26XXM (0x03) // EX. MSG2633M
#define CHIP_TYPE_MSG22XX (0x7A) // EX. MSG2238/MSG2256
#define CHIP_TYPE_MSG28XX \
	(0x85) // EX. MSG2833/MSG2835/MSG2836/MSG2840/MSG2856/MSG5846
...
#define MAX_UPDATE_FIRMWARE_BUFFER_SIZE \
	(130) // 130KB. The size shall be large enough for stored any kind firmware size of MSG22XX(48.5KB)/MSG28XX(130KB)/MSG58XX(130KB)/MSG58XXA(130KB).

#define MAX_I2C_TRANSACTION_LENGTH_LIMIT \
	(250) //(128) // Please change the value depends on the I2C transaction limitation for the platform that you are using.
#define MAX_TOUCH_IC_REGISTER_BANK_SIZE \
	(256) // It is a fixed value and shall not be modified.
...
#define MUTUAL_DEBUG_MODE_PACKET_LENGTH \
	(1280) // for MSG28xx. It is a predefined maximum packet length, not the actual packet length which queried from firmware.
...
#define MSG28XX_FIRMWARE_WHOLE_SIZE         \
	(MSG28XX_FIRMWARE_MAIN_BLOCK_SIZE + \
	 MSG28XX_FIRMWARE_INFO_BLOCK_SIZE) //130K

#define MSG28XX_EMEM_SIZE_BYTES_PER_ONE_PAGE (128)
#define MSG28XX_EMEM_SIZE_BYTES_ONE_WORD (4)

#define MSG28XX_EMEM_MAIN_MAX_ADDR \
	(0x3FFF) //0~0x3FFF = 0x4000 = 16384 = 65536/4
...
typedef enum { _50p, _40p, _30p, _20p, _10p } ItoTestCfbValue_e;
...
extern int mstar_get_reg_xbit(u16 nAddr, u8 *pRxData, u16 nLength,
...
extern int mstar_reg_get_xbit_write_4byte_value(u16 nAddr, u8 *pRxData,
						u16 nLength,
						u16 nMaxI2cLengthLimit);

extern int mstar_get_raw_data(struct ts_rawdata_info *info,
