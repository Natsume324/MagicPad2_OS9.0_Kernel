...
#define FOCAL_TAG                                                              \
	((sizeof(__func__) > sizeof("focal")) ? (__func__ + sizeof("focal")) : \
						__func__)

#define FTS_TAG                                                            \
	((sizeof(__func__) > sizeof("fts")) ? (__func__ + sizeof("fts")) : \
					      __func__)

#define FT8201_TAG                                   \
	((sizeof(__func__) > sizeof("focal_8201")) ? \
...
extern int focal_8201_get_raw_data(struct ts_rawdata_info *info,
				   struct ts_cmd_node *out_cmd);
extern int focal_get_raw_data(struct ts_rawdata_info *info,
			      struct ts_cmd_node *out_cmd);
