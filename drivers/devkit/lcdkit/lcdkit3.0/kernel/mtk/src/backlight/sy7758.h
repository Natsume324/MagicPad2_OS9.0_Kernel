...
#define sy7758_emerg(msg, ...)                                          \
	do {                                                            \
		if (sy7758_msg_level > 0)                               \
			printk(KERN_EMERG "[sy7758]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
#define sy7758_alert(msg, ...)                                          \
	do {                                                            \
		if (sy7758_msg_level > 1)                               \
			printk(KERN_ALERT "[sy7758]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
#define sy7758_crit(msg, ...)                                          \
	do {                                                           \
		if (sy7758_msg_level > 2)                              \
			printk(KERN_CRIT "[sy7758]%s: " msg, __func__, \
			       ##__VA_ARGS__);                         \
	} while (0)
#define sy7758_err(msg, ...)                                          \
	do {                                                          \
		if (sy7758_msg_level > 3)                             \
			printk(KERN_ERR "[sy7758]%s: " msg, __func__, \
			       ##__VA_ARGS__);                        \
	} while (0)
#define sy7758_warning(msg, ...)                                          \
	do {                                                              \
		if (sy7758_msg_level > 4)                                 \
			printk(KERN_WARNING "[sy7758]%s: " msg, __func__, \
			       ##__VA_ARGS__);                            \
	} while (0)
#define sy7758_notice(msg, ...)                                          \
	do {                                                             \
		if (sy7758_msg_level > 5)                                \
			printk(KERN_NOTICE "[sy7758]%s: " msg, __func__, \
			       ##__VA_ARGS__);                           \
	} while (0)
#define sy7758_info(msg, ...)                                          \
	do {                                                           \
		if (sy7758_msg_level > 6)                              \
			printk(KERN_INFO "[sy7758]%s: " msg, __func__, \
			       ##__VA_ARGS__);                         \
	} while (0)
#define sy7758_debug(msg, ...)                                          \
	do {                                                            \
		if (sy7758_msg_level > 7)                               \
			printk(KERN_DEBUG "[sy7758]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
