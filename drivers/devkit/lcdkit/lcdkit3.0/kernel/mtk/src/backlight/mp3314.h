...
#define mp3314_emerg(msg, ...)                                          \
	do {                                                            \
		if (mp3314_msg_level > 0)                               \
			printk(KERN_EMERG "[mp3314]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
#define mp3314_alert(msg, ...)                                          \
	do {                                                            \
		if (mp3314_msg_level > 1)                               \
			printk(KERN_ALERT "[mp3314]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
#define mp3314_crit(msg, ...)                                          \
	do {                                                           \
		if (mp3314_msg_level > 2)                              \
			printk(KERN_CRIT "[mp3314]%s: " msg, __func__, \
			       ##__VA_ARGS__);                         \
	} while (0)
#define mp3314_err(msg, ...)                                          \
	do {                                                          \
		if (mp3314_msg_level > 3)                             \
			printk(KERN_ERR "[mp3314]%s: " msg, __func__, \
			       ##__VA_ARGS__);                        \
	} while (0)
#define mp3314_warning(msg, ...)                                          \
	do {                                                              \
		if (mp3314_msg_level > 4)                                 \
			printk(KERN_WARNING "[mp3314]%s: " msg, __func__, \
			       ##__VA_ARGS__);                            \
	} while (0)
#define mp3314_notice(msg, ...)                                          \
	do {                                                             \
		if (mp3314_msg_level > 5)                                \
			printk(KERN_NOTICE "[mp3314]%s: " msg, __func__, \
			       ##__VA_ARGS__);                           \
	} while (0)
#define mp3314_info(msg, ...)                                          \
	do {                                                           \
		if (mp3314_msg_level > 6)                              \
			printk(KERN_INFO "[mp3314]%s: " msg, __func__, \
			       ##__VA_ARGS__);                         \
	} while (0)
#define mp3314_debug(msg, ...)                                          \
	do {                                                            \
		if (mp3314_msg_level > 7)                               \
			printk(KERN_DEBUG "[mp3314]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
