...
#define rt4539_emerg(msg, ...)                                          \
	do {                                                            \
		if (rt4539_msg_level > 0)                               \
			printk(KERN_EMERG "[rt4539]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
#define rt4539_alert(msg, ...)                                          \
	do {                                                            \
		if (rt4539_msg_level > 1)                               \
			printk(KERN_ALERT "[rt4539]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
#define rt4539_crit(msg, ...)                                          \
	do {                                                           \
		if (rt4539_msg_level > 2)                              \
			printk(KERN_CRIT "[rt4539]%s: " msg, __func__, \
			       ##__VA_ARGS__);                         \
	} while (0)
#define rt4539_err(msg, ...)                                          \
	do {                                                          \
		if (rt4539_msg_level > 3)                             \
			printk(KERN_ERR "[rt4539]%s: " msg, __func__, \
			       ##__VA_ARGS__);                        \
	} while (0)
#define rt4539_warning(msg, ...)                                          \
	do {                                                              \
		if (rt4539_msg_level > 4)                                 \
			printk(KERN_WARNING "[rt4539]%s: " msg, __func__, \
			       ##__VA_ARGS__);                            \
	} while (0)
#define rt4539_notice(msg, ...)                                          \
	do {                                                             \
		if (rt4539_msg_level > 5)                                \
			printk(KERN_NOTICE "[rt4539]%s: " msg, __func__, \
			       ##__VA_ARGS__);                           \
	} while (0)
#define rt4539_info(msg, ...)                                          \
	do {                                                           \
		if (rt4539_msg_level > 6)                              \
			printk(KERN_INFO "[rt4539]%s: " msg, __func__, \
			       ##__VA_ARGS__);                         \
	} while (0)
#define rt4539_debug(msg, ...)                                          \
	do {                                                            \
		if (rt4539_msg_level > 7)                               \
			printk(KERN_DEBUG "[rt4539]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
