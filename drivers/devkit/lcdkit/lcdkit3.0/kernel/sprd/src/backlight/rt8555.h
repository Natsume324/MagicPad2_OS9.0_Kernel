...
#define rt8555_emerg(msg, ...)                                          \
	do {                                                            \
		if (rt8555_msg_level > 0)                               \
			printk(KERN_EMERG "[rt8555]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
#define rt8555_alert(msg, ...)                                          \
	do {                                                            \
		if (rt8555_msg_level > 1)                               \
			printk(KERN_ALERT "[rt8555]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
#define rt8555_crit(msg, ...)                                          \
	do {                                                           \
		if (rt8555_msg_level > 2)                              \
			printk(KERN_CRIT "[rt8555]%s: " msg, __func__, \
			       ##__VA_ARGS__);                         \
	} while (0)
#define rt8555_err(msg, ...)                                          \
	do {                                                          \
		if (rt8555_msg_level > 3)                             \
			printk(KERN_ERR "[rt8555]%s: " msg, __func__, \
			       ##__VA_ARGS__);                        \
	} while (0)
#define rt8555_warning(msg, ...)                                          \
	do {                                                              \
		if (rt8555_msg_level > 4)                                 \
			printk(KERN_WARNING "[rt8555]%s: " msg, __func__, \
			       ##__VA_ARGS__);                            \
	} while (0)
#define rt8555_notice(msg, ...)                                          \
	do {                                                             \
		if (rt8555_msg_level > 5)                                \
			printk(KERN_NOTICE "[rt8555]%s: " msg, __func__, \
			       ##__VA_ARGS__);                           \
	} while (0)
#define rt8555_info(msg, ...)                                          \
	do {                                                           \
		if (rt8555_msg_level > 6)                              \
			printk(KERN_INFO "[rt8555]%s: " msg, __func__, \
			       ##__VA_ARGS__);                         \
	} while (0)
#define rt8555_debug(msg, ...)                                          \
	do {                                                            \
		if (rt8555_msg_level > 7)                               \
			printk(KERN_DEBUG "[rt8555]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
