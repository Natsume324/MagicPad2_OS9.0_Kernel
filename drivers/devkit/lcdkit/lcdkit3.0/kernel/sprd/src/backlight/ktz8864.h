...
#define ktz8864_emerg(msg, ...)                                          \
	do {                                                             \
		if (ktz8864_msg_level > 0)                               \
			printk(KERN_EMERG "[ktz8864]%s: " msg, __func__, \
			       ##__VA_ARGS__);                           \
	} while (0)
#define ktz8864_alert(msg, ...)                                          \
	do {                                                             \
		if (ktz8864_msg_level > 1)                               \
			printk(KERN_ALERT "[ktz8864]%s: " msg, __func__, \
			       ##__VA_ARGS__);                           \
	} while (0)
#define ktz8864_crit(msg, ...)                                          \
	do {                                                            \
		if (ktz8864_msg_level > 2)                              \
			printk(KERN_CRIT "[ktz8864]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
#define ktz8864_err(msg, ...)                                          \
	do {                                                           \
		if (ktz8864_msg_level > 3)                             \
			printk(KERN_ERR "[ktz8864]%s: " msg, __func__, \
			       ##__VA_ARGS__);                         \
	} while (0)
#define ktz8864_warning(msg, ...)                                          \
	do {                                                               \
		if (ktz8864_msg_level > 4)                                 \
			printk(KERN_WARNING "[ktz8864]%s: " msg, __func__, \
			       ##__VA_ARGS__);                             \
	} while (0)
#define ktz8864_notice(msg, ...)                                          \
	do {                                                              \
		if (ktz8864_msg_level > 5)                                \
			printk(KERN_NOTICE "[ktz8864]%s: " msg, __func__, \
			       ##__VA_ARGS__);                            \
	} while (0)
#define ktz8864_info(msg, ...)                                          \
	do {                                                            \
		if (ktz8864_msg_level > 6)                              \
			printk(KERN_INFO "[ktz8864]%s: " msg, __func__, \
			       ##__VA_ARGS__);                          \
	} while (0)
#define ktz8864_debug(msg, ...)                                          \
	do {                                                             \
		if (ktz8864_msg_level > 7)                               \
			printk(KERN_DEBUG "[ktz8864]%s: " msg, __func__, \
			       ##__VA_ARGS__);                           \
	} while (0)
