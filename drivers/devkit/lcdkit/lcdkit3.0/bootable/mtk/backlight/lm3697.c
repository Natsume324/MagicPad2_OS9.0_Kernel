...
static int lm3697_i2c_read_u8(unsigned char addr, unsigned char *dataBuffer)
{
	...
	*dataBuffer = addr;
	...
	len = 1;
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write_read(lm3697_i2c.id, lm3697_i2c.addr, dataBuffer,
				 len, len, NULL);
#else
...
static int lm3697_i2c_write_u8(unsigned char addr, unsigned char value)
{
	...
	len = 2;
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write(lm3697_i2c.id, lm3697_i2c.addr, write_data, len,
			    NULL);
#else
	lm3697_i2c.mode = ST_MODE;
	lm3697_i2c.speed = 100;
...
static int lm3697_parse_dts(void)
{
	...
	for (i = 0; i < LM3697_RW_REG_MAX; i++) {
		ret = lcd_kit_parse_get_u32_default(
			DTS_COMP_LM3697, lm3697_dts_string[i],
...
int lm3697_init(void)
{
	...
	ret = lcd_kit_parse_get_u32_default(DTS_COMP_LM3697, LM3697_SUPPORT,
					    &lm3697_bl_info.lm3697_support, 0);
	...
	ret = lcd_kit_parse_get_u32_default(DTS_COMP_LM3697, LM3697_I2C_BUS_ID,
					    &lm3697_bl_info.lm3697_i2c_bus_id,
					    0);
	if (ret < 0) {
		lm3697_bl_info.lm3697_i2c_bus_id = 0;
		return 0;
	}
	ret = lcd_kit_parse_get_u32_default(DTS_COMP_LM3697, LM3697_HW_ENABLE,
	...
	if (lm3697_bl_info.lm3697_hw_en) {
		ret = lcd_kit_parse_get_u32_default(
			DTS_COMP_LM3697, LM3697_HW_EN_GPIO,
		...
		ret = lcd_kit_parse_get_u32_default(
			DTS_COMP_LM3697, LM3697_HW_EN_DELAY,
	...
	ret = lcd_kit_parse_get_u32_default(
		DTS_COMP_LM3697, LM3697_BACKLIGHT_CONFIG_LSB_REG_ADDR,
	...
	ret = lcd_kit_parse_get_u32_default(
		DTS_COMP_LM3697, LM3697_BACKLIGHT_CONFIG_MSB_REG_ADDR,
