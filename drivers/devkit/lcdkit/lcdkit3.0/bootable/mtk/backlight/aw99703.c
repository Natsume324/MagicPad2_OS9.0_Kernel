...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write_read(aw99703_i2c.id, aw99703_i2c.addr, data_buffer,
				 len, len, NULL);
#else
...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write(aw99703_i2c.id, aw99703_i2c.addr, write_data, len,
			    NULL);
#else
	aw99703_i2c.mode = ST_MODE;
	aw99703_i2c.speed = AW99703_I2C_SPEED;
...
static void aw99703_parse_dts(void)
{
	...
	for (i = 0; i < AW99703_RW_REG_MAX; i++) {
		ret = lcd_kit_parse_get_u32_default(
			DTS_COMP_AW99703, aw99703_dts_string[i],
...
static int aw99703_set_backlight(unsigned int bl_level)
{
	...
	bl_level =
		bl_level * aw99703_bl_info.bl_level / AW99703_BL_DEFAULT_LEVEL;
...
int aw99703_init(struct mtk_panel_info *pinfo)
{
	...
	ret = lcd_kit_parse_get_u32_default(DTS_COMP_AW99703, AW99703_SUPPORT,
					    &aw99703_bl_info.aw99703_support,
					    0);
	...
	ret = lcd_kit_parse_get_u32_default(DTS_COMP_AW99703,
					    AW99703_I2C_BUS_ID,
					    &aw99703_bl_info.aw99703_i2c_bus_id,
					    0);
	if (ret < 0) {
		LCD_KIT_ERR("parse dts aw99703_i2c_bus_id fail!\n");
		return LCD_KIT_FAIL;
	}
	ret = lcd_kit_parse_get_u32_default(DTS_COMP_AW99703, AW99703_HW_ENABLE,
	...
	ret = lcd_kit_parse_get_u32_default(DTS_COMP_AW99703, AW99703_BL_LEVEL,
					    &aw99703_bl_info.bl_level,
	...
	if (aw99703_bl_info.aw99703_hw_en) {
		ret = lcd_kit_parse_get_u32_default(
			DTS_COMP_AW99703, AW99703_HW_EN_GPIO,
		...
		ret = lcd_kit_parse_get_u32_default(
			DTS_COMP_AW99703, AW99703_HW_EN_DELAY,
