...
static struct aw3750x_voltage voltage_table[] = {
	{LCD_BIAS_VOL_40, AW3750X_VOL_40}, {LCD_BIAS_VOL_41, AW3750X_VOL_41},
	{LCD_BIAS_VOL_42, AW3750X_VOL_42}, {LCD_BIAS_VOL_43, AW3750X_VOL_43},
	{LCD_BIAS_VOL_44, AW3750X_VOL_44}, {LCD_BIAS_VOL_45, AW3750X_VOL_45},
	{LCD_BIAS_VOL_46, AW3750X_VOL_46}, {LCD_BIAS_VOL_47, AW3750X_VOL_47},
	{LCD_BIAS_VOL_48, AW3750X_VOL_48}, {LCD_BIAS_VOL_49, AW3750X_VOL_49},
	{LCD_BIAS_VOL_50, AW3750X_VOL_50}, {LCD_BIAS_VOL_51, AW3750X_VOL_51},
	{LCD_BIAS_VOL_52, AW3750X_VOL_52}, {LCD_BIAS_VOL_53, AW3750X_VOL_53},
	{LCD_BIAS_VOL_54, AW3750X_VOL_54}, {LCD_BIAS_VOL_55, AW3750X_VOL_55},
	{LCD_BIAS_VOL_56, AW3750X_VOL_56}, {LCD_BIAS_VOL_57, AW3750X_VOL_57},
	{LCD_BIAS_VOL_58, AW3750X_VOL_58}, {LCD_BIAS_VOL_59, AW3750X_VOL_59},
...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write_read(aw3750x_i2c.id, aw3750x_i2c.addr, databuffer,
				 len, len, NULL);
#else
...
#ifdef MTK_LCD_KIT_LK2_SUPPORT
	ret = mtk_i2c_write(aw3750x_i2c.id, aw3750x_i2c.addr, write_data, len,
			    NULL);
#else
	aw3750x_i2c.mode = ST_MODE;
	aw3750x_i2c.speed = aw3750x_I2C_SPEED;
...
int aw3750x_init(void)
{
	...
	ret = lcd_kit_parse_get_u32_default(DTS_COMP_AW3750X, AW3750X_SUPPORT,
					    &support, 0);
	if ((ret < 0) || (!support)) {
	...
	ret = lcd_kit_parse_get_u32_default(DTS_COMP_AW3750X,
					    AW3750X_I2C_BUS_ID, &i2c_bus_id, 0);
	if (ret < 0) {
		i2c_bus_id = 0;
		return LCD_KIT_OK;
	}
