...
struct bias_bl_common_ops {
	int (*i2c_read_u8)(unsigned char i2c_num, unsigned char chip_addr,
			   unsigned char reg, unsigned char *val);
	int (*i2c_write_u8)(unsigned char i2c_num, unsigned char chip_addr,
			    unsigned char reg, unsigned char val);
	int (*i2c_update_u8)(unsigned char i2c_num, unsigned char chip_addr,
			     unsigned char reg, unsigned char mask,
			     unsigned char val);
	int (*dts_get_data_by_property)(const char *compatible,
					const char *prop_name, int *data,
					unsigned int *len);
	void (*dts_set_ic_name)(const char *prop_name, const char *name);
	int (*dts_get_ic_num)(const char *prop_name);
	int (*dts_get_ic_name_index)(const char *prop_name, int idx,
