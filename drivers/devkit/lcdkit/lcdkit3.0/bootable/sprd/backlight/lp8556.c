...
static void lp8556_enable(void)
{
	...
	if (lp8556_bl_info.lp8556_hw_en) {
		...
		sprd_gpio_direction_output(
			NULL, lp8556_bl_info.lp8556_hw_en_gpio, GPIO_OUT_ONE);
		if (lp8556_bl_info.dual_ic) {
			sprd_gpio_request(NULL,
					  lp8556_bl_info.lp8556_hw_en_gpio);
			sprd_gpio_direction_output(
				NULL, lp8556_bl_info.lp8556_hw_en_gpio,
				GPIO_OUT_ONE);
		}
...
static void lp8556_disable(void)
{
	if (lp8556_bl_info.lp8556_hw_en) {
		sprd_gpio_direction_output(
			NULL, lp8556_bl_info.lp8556_hw_en_gpio, GPIO_OUT_ZERO);
		if (lp8556_bl_info.dual_ic)
			sprd_gpio_direction_output(
				NULL, lp8556_bl_info.lp8556_hw_en_gpio,
				GPIO_OUT_ZERO);
