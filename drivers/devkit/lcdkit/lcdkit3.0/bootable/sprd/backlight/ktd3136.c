...
static char *ktd3136_dts_string[KTD3136_RW_REG_MAX] = {
	...
	"ktd3136_reg_onoff_ctrl",	 "ktd3136_reg_boost_ctrl",
...
static unsigned int ktd3136_reg_addr[KTD3136_RW_REG_MAX] = {
	...
	KTD3136_REG_CTRL_ONOFF_CTRL,	 KTD3136_REG_CTRL_BOOT_CTRL,
...
static int ktd3136_device_verify(void)
{
	...
	if (ktd3136_bl_info.ktd3136_hw_en) {
		...
		sprd_gpio_direction_output(
			NULL, ktd3136_bl_info.ktd3136_hw_en_gpio, GPIO_OUT_ONE);
