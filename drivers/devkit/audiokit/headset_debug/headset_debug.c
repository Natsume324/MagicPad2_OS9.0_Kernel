					...
					loff_t *ppos)
{
	...
	byte_read = simple_read_from_buffer(user_buf, count, ppos, kn_buf,
					    strlen(kn_buf));
					 ...
					 size_t count, loff_t *ppos)
{
	...
	byte_writen = simple_write_to_buffer(kn_buf, INT_HEX_STR_SIZE - 1, ppos,
					     user_buf, count);
...
static void headset_debug_init_fs(void)
{
	...
	if (!debugfs_create_file("state", 0640, g_headset_debug.df_dir, NULL,
				 &headset_debug_state_fops)) {
