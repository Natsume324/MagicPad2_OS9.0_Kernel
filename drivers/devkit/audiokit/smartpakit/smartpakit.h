...
struct self_dev_regulator_reg_ops {
	int (*self_dev_regulator_reg_read)(int i2c_addr, int reg_addr,
					   int *value);
	int (*self_dev_regulator_reg_write)(int i2c_addr, int reg_addr,
					    int mask, int value);
};
...
struct smartpakit_dsm_info_ops {
	...
	int (*smartpa_info)(struct smartpakit_i2c_priv *i2c_priv,
