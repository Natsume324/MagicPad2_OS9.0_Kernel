...
typedef int (*out_print)(unsigned long addr, unsigned long size,
...
int print_to_minidump(unsigned long addr, unsigned long size,
		      struct microdump_page_info *info);
int print_to_console(unsigned long addr, unsigned long size,
		     struct microdump_page_info *info);
