...
#define WIFIPRO_TCP_INC_STATS(net, field) \
	SNMP_INC_STATS((net)->mib.wifipro_tcp_statistics, field)
#define WIFIPRO_TCP_INC_STATS_BH(net, field) \
	__SNMP_INC_STATS((net)->mib.wifipro_tcp_statistics, field)
#define WIFIPRO_TCP_DEC_STATS(net, field) \
	SNMP_DEC_STATS((net)->mib.wifipro_tcp_statistics, field)
#define WIFIPRO_TCP_ADD_STATS_USER(net, field, val) \
	SNMP_ADD_STATS((net)->mib.wifipro_tcp_statistics, field, val)
#define WIFIPRO_TCP_ADD_STATS(net, field, val) \
	SNMP_ADD_STATS((net)->mib.wifipro_tcp_statistics, field, val)
...
static unsigned char s_validate_state[] = {TCP_ESTABLISHED, TCP_SYN_SENT,
					   TCP_SYN_RECV, TCP_LISTEN};
