...
#define wifi_audio_log_info(fmt, ...)                              \
	wifi_audio_log_print(WIFI_AUDIO_LOG_LOW,                   \
			     "wifi_audio<INFO>[%s:%d]: " fmt "\n", \
			     __FUNCTION__, __LINE__, ##__VA_ARGS__)

#define wifi_audio_log_warn(fmt, ...)                                \
	wifi_audio_log_print(WIFI_AUDIO_LOG_MID,                     \
			     "wifi_audio<WARNNG>[%s:%d]: " fmt "\n", \
			     __FUNCTION__, __LINE__, ##__VA_ARGS__)

#define wifi_audio_log_err(fmt, ...)                                \
	wifi_audio_log_print(WIFI_AUDIO_LOG_HI,                     \
			     "wifi_audio<ERROR>[%s:%d]: " fmt "\n", \
			     __FUNCTION__, __LINE__, ##__VA_ARGS__)
