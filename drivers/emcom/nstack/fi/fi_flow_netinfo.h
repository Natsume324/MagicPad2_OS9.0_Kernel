...
extern uint32_t fi_ipv4_flow_netinfo_hash(__be32 addr1, __u16 port1,
					  __be32 addr2, __be16 port2,
					  char *flow, int str_len,
					  bool exchange);

extern struct fi_netinfo_flow_head *fi_ipv4_flow_netinfo_header(uint32_t index);

extern struct fi_netinfo_flow_node *
...
extern uint32_t fi_ipv6_flow_netinfo_hash(const struct in6_addr *addr1,
					  __u16 port1,
...
static inline bool
fi_flow_app_netinfo_rpt_enable(struct fi_netinfo_flow_node *flow)
{
