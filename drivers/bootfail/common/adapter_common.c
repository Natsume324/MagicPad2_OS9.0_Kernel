...
static int bootfail_memset(void *dst, unsigned long dst_max, int c,
			   unsigned long count)
{
	size_t cnt;
...
static int bootfail_memcpy(void *dst, unsigned long dst_max, const void *src,
			   unsigned long count)
{
	size_t cnt;
...
static int bootfail_strncpy(char *dst, unsigned long dst_max, const char *src,
			    unsigned long count)
{
	size_t cnt;
...
static int bootfail_memcmp(const void *dst, const void *src,
			   unsigned long count)
{
...
static void get_adapter(struct adapter *padp)
{
	...
	padp->sec_funcs.bootfail_strlen = bootfail_strlen;
