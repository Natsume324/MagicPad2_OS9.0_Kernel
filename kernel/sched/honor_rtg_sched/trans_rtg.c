...
#if defined(CONFIG_HONOR_RTG_FRAME_USE_MIN_UTIL) && \
	!defined(CONFIG_HONOR_SCHED_VIP) &&         \
...
#ifdef CONFIG_HN_QOS_THREAD
void trans_rtg_sched_enqueue(struct task_struct *task, struct task_struct *from,
