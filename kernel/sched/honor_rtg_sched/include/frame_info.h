...
#define FRAME_SETTIME (FRAME_START | FRAME_END | FRAME_USE_MARGIN_IMME)
...
frame_info_rtg(const struct frame_info *frame_info)
{
	return frame_info->rtg;
}

static inline struct group_time *
frame_info_rtg_load(const struct frame_info *frame_info)
{
