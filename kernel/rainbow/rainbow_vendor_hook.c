...
void rb_handle_die_kernel_fault(void *unused, const char *msg,
...
void rb_handle_do_sea(void *unused, unsigned long far, unsigned long esr,
		      struct pt_regs *regs)
{
	rb_sreason_set("SEA");
}
...
void rb_handle_arm64_serror_panic(void *unused, struct pt_regs *regs,
				  unsigned long esr)
{
	rb_sreason_set("serror");
}

void rb_handle_report_bug(void *unused, const char *file, unsigned int line,
