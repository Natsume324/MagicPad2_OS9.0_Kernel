...
static unsigned int g_critical_memory = 1100;
static unsigned int default_pgpress_level = 5;
static unsigned int default_exempt_level = 10;
static unsigned int default_min_window = 2;
static unsigned int quota_ratio = 20;
 ...
 */
void refault_monitor(int delta)
{
	unsigned int time = 0;
